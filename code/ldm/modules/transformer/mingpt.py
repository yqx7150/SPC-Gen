...
class GPT(nn.Module):
    ...
    def forward(self, idx, embeddings=None, targets=None):
        ...
        assert t <= self.block_size, "Cannot forward, models block size is exhausted."
...
def sample(model, x, steps, temperature=1.0, sample=False, top_k=None):
    ...
    the sequence, feeding the predictions back into the models each time. Clearly the sampling
