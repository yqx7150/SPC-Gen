...
from ldm.modules.util import SOSProvider
...
class Net2NetTransformer(pl.LightningModule):
    ...
    def sample(self, x, c, steps, temperature=1.0, sample=False, top_k=None,
        ...
        if self.pkeep <= 0.0:
            ...
            for k in range(steps):
                callback(k)
                assert x.size(1) <= block_size  # make sure models can see conditioning
    ...
    def log_images(self, batch, temperature=None, top_k=None, callback=None, lr_interface=False, **kwargs):
        ...
        if self.cond_stage_key in ["objects_bbox", "objects_center_points"]:
            ...
            dataset = kwargs["pl_module"].trainer.datamodule.datasets["val"]
