...
from ldm.data.openimages_bbox_helpers.category_mappings import \
    open_images_unify_categories_for_coco
from ldm.data.openimages_bbox_helpers.openimages_builder import (
    CoordinatesBoundingBoxConditionalBuilder, RescaledAnnotationsBuilder)
from ldm.data.openimages_bbox_helpers.openimages_builderutils import (
...
from ldm.data.openimages_bbox_helpers.selected_categories import \
...
OPEN_IMAGES_STRUCTURE = {
    ...
    'val': {
        'top_level': '',
        'class_descriptions': 'class-descriptions-boxable.csv',
        'annotations': 'val-annotations-bbox.csv',
        'file_list': 'val-images.csv',
        'files': 'val'
    },
    'test': {
        'top_level': '',
