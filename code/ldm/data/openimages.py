...
class FullOpenImagesBase(Dataset):
    def __init__(self, size=None, crop_size=None, interpolation="bicubic",
        ...
        self.data_files = {"train": FULL_TRAIN_FILES, "val": VALIDATION_FILES, "test": TEST_FILES}
...
class SuperresOpenImages(Dataset):
    def __init__(self, size=None, crop_size=None, interpolation="bicubic",
                 ...
                 data_root="data/open_images_annotations_100/train", random_crop=True,
                 corrupt_files="data/open_images_annotations_100/train.txt"):
        """
...
class OpenImagesBBoxValidation(OpenImagesBBoxBase):
    ...
    def __init__(self, size, encode_bbox=True, datapath='data/openimages', n_max_samples=-1,
        ...
        if keys is None:
            keys = ['image', 'coordinates_bbox', 'bbox_img', 'image_with_bboxes']
        self.size = size
        super().__init__(data_path=datapath, split='val', keys=keys,
...
class OpenImagesBase(Dataset):
    ...
    def __init__(self, size=None, random_crop=False, interpolation="bicubic",
        ...
        self.split = self.get_split()
        self.data_csv = {"train": TXT_TRAIN, "val": TXT_VAL}[self.split]
...
if __name__ == "__main__":
    ...
    # print('constructed val set.')
    # print(f"length of val split: {len(d3)}")
    # ex1 = d1[0]
