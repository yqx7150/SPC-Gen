...
if __name__ == "__main__":
    ...
    print(dsets.datasets["val"].conditional_builders)
    conditional_builder = dsets.datasets["val"].conditional_builders[conditional]
    ...
    for batch_no, batch in p_bar_1:
        ...
        for i, annotations in tqdm(enumerate(batch['annotations']), desc='within_batch', total=data_loader.batch_size):
            imgs = sample(model, annotations, dsets.datasets["val"], conditional_builder,
