...
```shell script
CUDA_VISIBLE_DEVICES=<GPU_ID> python scripts/sample_diffusion.py -r pre_trained_models/ldm/<model_spec>/models.ckpt -l <logdir> -n <\#samples> --batch_size <batch_size> -c <\#ddim steps> -e <\#eta> 
```
...
wget -O pre_trained_models/rdm/rdm768x768/models.ckpt https://ommer-lab.com/files/rdm/model.ckpt
```
