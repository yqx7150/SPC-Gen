...
dictionary=torch.load("pre_trained_models/ldm/layout2img-openimages256/models.ckpt",map_location='cpu')
...
#If you want to change the conditional keys in the pretrained models to a personal conditional models with random weights.
...
for i, params in enumerate(keys):
    new_dict['cond_stage_model.models.'+params]=s_d[params]
