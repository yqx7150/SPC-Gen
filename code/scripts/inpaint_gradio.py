...
if __name__ == "__main__":
    ...
    # models.load_state_dict(torch.load(r"D:\PycharmProject\latent-diffusion\logs\2023-08-21T12-55-40_captain512_inpaint\checkpoints\epoch=000181.ckpt")["state_dict"], strict=False)
