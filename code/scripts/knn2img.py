...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="path to config which constructs models",
    )

    parser.add_argument(
        "--ckpt",
        type=str,
        default="pre_trained_models/rdm/rdm768x768/models.ckpt",
        help="path to checkpoint of models",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="ViT-L/14",
        help="which CLIP models to use for retrieval and NN encoding",
    )
    parser.add_argument(
        "--database",
        type=str,
        ...
        with model.ema_scope():
            for n in trange(opt.n_iter, desc="Sampling"):
                ...
                for prompts in tqdm(data, desc="data"):
                    ...
                    if isinstance(prompts, tuple):
                        prompts = list(prompts)
                    shape = [16, opt.H // 16, opt.W // 16]  # note: currently hardcoded for f16 models
